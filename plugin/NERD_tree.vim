...
call s:initVariable("g:NERDTreeMapActivateNode", "go")
call s:initVariable("g:NERDTreeMapActivateFileNode", "go")
call s:initVariable("g:NERDTreeMapChangeRoot", "C")
call s:initVariable("g:NERDTreeMapChdir", "cd")
call s:initVariable("g:NERDTreeMapCloseChildren", "X")
call s:initVariable("g:NERDTreeMapCloseDir", "x")
call s:initVariable("g:NERDTreeMapDeleteBookmark", "D")
call s:initVariable("g:NERDTreeMapMenu", "<f2>")
call s:initVariable("g:NERDTreeMapHelp", "?")
call s:initVariable("g:NERDTreeMapJumpFirstChild", "gk")
call s:initVariable("g:NERDTreeMapJumpLastChild", "gj")
call s:initVariable("g:NERDTreeMapJumpNextSibling", "<nop>")
call s:initVariable("g:NERDTreeMapJumpParent", "p")
call s:initVariable("g:NERDTreeMapJumpPrevSibling", "<nop>")
call s:initVariable("g:NERDTreeMapJumpRoot", "P")
call s:initVariable("g:NERDTreeMapOpenExpl", "e")
call s:initVariable("g:NERDTreeMapOpenInTab", "t")
call s:initVariable("g:NERDTreeMapOpenInTabSilent", "T")
call s:initVariable("g:NERDTreeMapOpenRecursively", "O")
call s:initVariable("g:NERDTreeMapOpenVSplit2", ",l")
...
call s:initVariable("g:NERDTreeMapToggleFiles", "<nop>")
call s:initVariable("g:NERDTreeMapToggleFilters", "<nop>")
